# C# Application-restricted REST API - signed JWT authentication
...
This tutorial shows how to use C# to generate and sign a JWT, exchange this for an access token with our
...
our [GitHub repository](https://github.com/NHSDigital/hello-world-auth-examples/tree/main/application-restricted-signed-jwt-tutorials/csharp).
...
- a `HelloWorld` class located in the `program.cs` file. This class requests an access token and then uses that access token to send a GET request to the specified endpoint
